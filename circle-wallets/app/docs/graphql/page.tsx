            ...
            <div className="flex flex-col gap-2">
              <div className="flex gap-2">
                ...
                >
                  <Button className="bg-[#b6f09c] text-[#000000] hover:bg-[#b6f09c]/90 font-black text-xs uppercase tracking-widest w-full border-none shadow-xl shadow-[#b6f09c]/10">
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round" className="mr-2"><circle cx="12" cy="12" r="10"/><line x1="2" y1="12" x2="22" y2="12"/><path d="M12 2a15.3 15.3 0 0 1 4 10 15.3 15.3 0 0 1-4 10 15.3 15.3 0 0 1-4-10 15.3 15.3 0 0 1 4-10z"/></svg>
                    Open Playground
                  </Button>
                </a>
              </div>
              <div className="flex gap-2 w-full">
                ...
                <a 
                  ...
                  className="flex-1"
                >
                  <Button variant="ghost" size="sm" className="font-bold text-[10px] uppercase tracking-widest w-full text-[#a1a1aa] hover:text-[#b6f09c] hover:bg-[#b6f09c]/5">
                    <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" className="mr-2"><path d="M14.5 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V7.5L14.5 2z"/><polyline points="14 2 14 8 20 8"/></svg>
                    Studio
                  </Button>
                </a>
              </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
            <div className="flex items-start gap-3">
              <div className="w-10 h-10 rounded-lg bg-[#b6f09c]/10 border border-[#b6f09c]/20 flex items-center justify-center flex-shrink-0">
                <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" className="text-[#b6f09c]"><polyline points="22 12 18 12 15 21 9 3 6 12 2 12"/></svg>
              </div>
              <div>
                <h3 className="font-bold text-sm mb-1">Real-time Indexing</h3>
                <p className="text-xs text-muted-foreground">Events indexed within seconds of emission</p>
              </div>
            </div>

            <div className="flex items-start gap-3">
              <div className="w-10 h-10 rounded-lg bg-[#b6f09c]/10 border border-[#b6f09c]/20 flex items-center justify-center flex-shrink-0">
                <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" className="text-[#b6f09c]"><polygon points="12 2 2 7 12 12 22 7 12 2"/><polyline points="2 17 12 22 22 17"/><polyline points="2 12 12 17 22 12"/></svg>
              </div>
              <div>
                <h3 className="font-bold text-sm mb-1">Flexible Queries</h3>
                <p className="text-xs text-muted-foreground">Filter, sort, and paginate any entity</p>
              </div>
            </div>

            <div className="flex items-start gap-3">
              <div className="w-10 h-10 rounded-lg bg-[#b6f09c]/10 border border-[#b6f09c]/20 flex items-center justify-center flex-shrink-0">
                <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" className="text-[#b6f09c]"><line x1="12" y1="1" x2="12" y2="23"/><path d="M17 5H9.5a3.5 3.5 0 0 0 0 7h5a3.5 3.5 0 0 1 0 7H6"/></svg>
              </div>
              <div>
                <h3 className="font-bold text-sm mb-1">Aggregated Stats</h3>
                <p className="text-xs text-muted-foreground">Pre-computed revenue, counts, and metrics</p>
              </div>
            </div>

            <div className="flex items-start gap-3">
              <div className="w-10 h-10 rounded-lg bg-[#b6f09c]/10 border border-[#b6f09c]/20 flex items-center justify-center flex-shrink-0">
                <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" className="text-[#b6f09c]"><path d="M21 16V8a2 2 0 0 0-1-1.73l-7-4a2 2 0 0 0-2 0l-7 4A2 2 0 0 0 3 8v8a2 2 0 0 0 1 1.73l7 4a2 2 0 0 0 2 0l7-4A2 2 0 0 0 21 16z"/><polyline points="3.27 6.96 12 12.01 20.73 6.96"/><line x1="12" y1="22.08" x2="12" y2="12"/></svg>
              </div>
              <div>
                <h3 className="font-bold text-sm mb-1">Decentralized</h3>
                <p className="text-xs text-muted-foreground">No centralized database or backend needed</p>
              </div>
            </div>
          </div>
        </div>
          ...
          <aside className="hidden lg:block w-full sticky top-24 self-start max-h-[calc(100vh-8rem)] overflow-y-auto no-scrollbar">
            <div className="space-y-6">
              ...
              <div className="border border-border rounded-lg p-4 bg-muted/30">
                <h4 className="font-bold text-sm mb-3 uppercase tracking-widest text-muted-foreground">Quick Links</h4>
                <div className="space-y-2 text-sm">
                  ...
                  <Link href="/docs" className="flex items-center gap-2 text-muted-foreground hover:text-primary hover:underline">
              ...
              {/* Endpoint Info */}
              <div className="border border-border rounded-lg p-4 bg-muted/30">
                <h4 className="font-bold text-sm mb-3 uppercase tracking-widest text-muted-foreground">Endpoint</h4>
        ...
        <div className="container mx-auto px-4 md:px-8 py-8">
          <div className="flex flex-col md:flex-row items-center justify-between gap-4 text-sm text-muted-foreground">
            ...
            <div className="flex items-center gap-6">
              ...
              <Link href="/docs" className="hover:text-foreground transition-colors">REST API</Link>
