...
We couldn't locate the \`api-reference.md\` file. Please ensure it exists in \`docs/developer/\`.`;
  ...
  return (
    <div className="min-h-screen bg-background relative selection:bg-primary/20 flex flex-col">
      ...
      {/* Hero Banner */}
      <div className="w-full border-b border-border bg-linear-to-br from-[#b6f09c]/5 via-background to-background">
          ...
          <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
            <div className="flex-1">
              ...
              <p className="text-muted-foreground text-base md:text-lg max-w-3xl">
                Integrate Mecha Pay into your platform with our robust JSON API.
                Handle subscriptions, manage keys, and track revenue
                programmatically.
              </p>
            </div>
        ...
        <div className="container mx-auto px-4 md:px-8 py-6">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="flex items-start gap-3">
              <div className="w-10 h-10 rounded-lg bg-[#b6f09c]/10 border border-[#b6f09c]/20 flex items-center justify-center shrink-0">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="18"
                  height="18"
              ...
              <div>
                ...
                <p className="text-xs text-muted-foreground">
                  Standardized header-based API key validation for all requests
                </p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-muted-foreground">
                  Real-time status updates synced across blockchain and metadata
                  layers
                </p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-muted-foreground">
                  Clean JSON responses and robust error handling for easy
                  integration
                </p>
              </div>
            </div>
                ...
                <div className="space-y-2 text-sm">
                  ...
                  >
                    <svg
                      ...
                      strokeLinecap="round"
                      strokeLinejoin="round"
                      className="group-hover:text-[#b6f09c] transition-colors"
                    >
                  ...
                  <Link
                    ...
                    className="flex items-center gap-2 text-muted-foreground hover:text-primary hover:underline group"
                  >
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      width="14"
