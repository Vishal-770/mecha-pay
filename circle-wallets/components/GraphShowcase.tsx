        ...
        <div className="grid lg:grid-cols-2 gap-20 items-center">
          ...
          <div className="order-2 lg:order-1 relative group">
            ...
            <div className="relative bg-[#0b0b0f] border border-[#ffffff]/5 rounded-[2.5rem] p-8 shadow-2xl overflow-hidden min-h-[480px]">
               ...
               <div className="flex items-center justify-between mb-8 border-b border-[#ffffff]/5 pb-6">
                 ...
                 <div className="px-3 py-1 bg-[#b6f09c]/10 rounded-md border border-[#b6f09c]/20">
                    <span className="text-[10px] font-mono text-[#b6f09c] font-bold">query SellerStats</span>
                 </div>
               </div>
               ...
               <div className="font-mono text-sm leading-relaxed">
                  ...
                  <div className="text-[#b6f09c]">query <span className="text-[#ffffff]">SellerStats</span>($seller: <span className="text-[#ffffff]">Bytes!</span>) {"{"}</div>
                  ...
                  <div className="pl-12 text-[#b6f09c]">totalGrossRevenue</div>
                  <div className="pl-12 text-[#b6f09c]">totalNetRevenue</div>
                  <div className="pl-12 text-[#ffffff]">updatedAt</div>
                  <div className="pl-6 text-[#ffffff]">{"}"}</div>
                  <div className="text-[#b6f09c]">{"}"}</div>
                  ...
                  <div className="mt-8 pt-6 border-t border-[#ffffff]/5">
                    ...
                    <div className="pl-12 flex gap-2">
                        ...
                        <span className="text-[#b6f09c]">"42,000 USDC"</span>
                    </div>
            ...
            <div className="absolute -top-6 -left-6 px-6 py-4 bg-[#000000] border border-[#ffffff]/10 rounded-2xl shadow-2xl flex items-center gap-3">
               <Database className="w-4 h-4 text-[#b6f09c]" />
          ...
          <div className="order-1 lg:order-2 flex flex-col gap-8">
            <div className="px-3 py-1 bg-[#b6f09c]/10 border border-[#b6f09c]/20 rounded-full w-fit">
              <span className="text-[#b6f09c] text-[10px] font-bold uppercase tracking-[0.2em] leading-none">The Graph Protocol</span>
            </div>
