...
export const Terminal = ({
  ...
  const content = (
    <div
      ref={containerRef}
      className={cn(
        "border-border bg-background z-0 h-full max-h-100 w-full max-w-lg rounded-xl border flex flex-col overflow-hidden",
        className
      )}
    >
      ...
      <pre className="p-4 flex-1 overflow-y-auto no-scrollbar">


        <code className="grid gap-y-1 whitespace-pre-wrap break-all">{wrappedChildren}</code>
      </pre>
    </div>
